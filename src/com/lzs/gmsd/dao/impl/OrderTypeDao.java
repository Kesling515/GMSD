...
public class OrderTypeDao extends HibernateDaoSupport implements BaseDao {
	...
	public List findObject() throws HibernateException {
		return (List) getHibernateTemplate().find("from OrderType");
	}
	...
	public List getObject(Object obj) throws HibernateException {
		return (List) getHibernateTemplate().find("from OrderType a where a.id=?", obj);
	}
