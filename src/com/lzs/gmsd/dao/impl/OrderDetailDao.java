...
public class OrderDetailDao extends HibernateDaoSupport implements BaseDao {
	...
	public List findObject() throws HibernateException {
		return (List) getHibernateTemplate().find("from OrderDetail");
	}
	...
	public List getObject(Object obj) throws HibernateException {
		return (List) getHibernateTemplate().find("from OrderDetail a where a.id=?", obj);
	}
